  ...
  <?php require("_header.inc.php"); ?>
    ...
    <p> Anschrift:
      ...
      <p>
        ...
        <br /> Oliver Köhler (<a href="mailto:oliver.koehler@lg-regensburg.de">oliver.koehler@lg-regensburg.de</a>)
        <br /> Gerit Wagner (<a href="mailto:gerit.wagner@lg-regensburg.de">gerit.wagner@lg-regensburg.de</a>)</p>
      <p>
        <span style="font-weight: bold">Gestaltung der Webseite</span>
        <br /> Lukas Ziegler (<a href="mailto:lukas.ziegler@lg-regensburg.de">lukas.ziegler@lg-regensburg.de</a>)</p>
      <hr />
      <p align="center">
        <a href="http://validator.w3.org/check?uri=referer" target="_blank">
          <img src="http://www.w3.org/Icons/valid-xhtml10" alt="Valid XHTML 1.0 Transitional" height="31" width="88" />
        </a>
        <a href="http://jigsaw.w3.org/css-validator/validator?uri=http://www.sparkassen-gala.de/impressum.php" target="_blank">
